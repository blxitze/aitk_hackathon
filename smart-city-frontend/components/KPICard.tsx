...
export default function KPICard({
  ...
  return (
    <div
      className={`relative overflow-hidden rounded-[12px] border border-[var(--border)] bg-[var(--bg-surface)] p-5 ${
    ...
    >
      ...
      {loading ? (
        <div className="space-y-3">
          ...
          <div className="h-9 w-32 animate-pulse rounded bg-[var(--bg-elevated)]" />
        </div>
      ) : (
        <>
          <p className="mb-3 pr-8 font-[family:var(--font-space-grotesk)] text-[11px] font-medium uppercase tracking-[0.08em] text-[var(--text-secondary)]">
            {label}
          </p>
          ...
          <div className="mb-3 flex flex-wrap items-baseline gap-0">
            ...
            <span className="ml-1 font-[family:var(--font-space-grotesk)] text-[13px] text-[var(--text-secondary)]">
              {unit}
            </span>
          </div>
